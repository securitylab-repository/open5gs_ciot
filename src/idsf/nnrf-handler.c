...
//                 idsf_timer_subscription_validity, subscription);
...
//             OGS_FSM_TRAN(&nf_instance->sm, idsf_nf_state_registered);
...
//         if (!handled) {
//             IDSF_NF_INSTANCE_CLEAR("NRF-notify", nf_instance);
//             ogs_sbi_header_free(&header);
//             return false;
//         }
        ...
        ogs_sbi_xact_t *xact, ogs_sbi_message_t *recvmsg)
{
    ...
    //                     nf_instance->id);
    //             IDSF_NF_INSTANCE_CLEAR("NRF-discover", nf_instance);
    //             continue;
    //         }
    ...
    // else {
    //     ogs_assert(true == idsf_sbi_send(nf_instance, xact));
    // }

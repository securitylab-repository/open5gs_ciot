...
void scp_nf_state_initial(ogs_fsm_t *s, scp_event_t *e)
{
    ...
    nf_instance->t_no_heartbeat->cb = scp_timer_nf_instance_no_heartbeat;
    ogs_assert(nf_instance->t_validity);
    nf_instance->t_validity->cb = scp_timer_nf_instance_validity;
...
void scp_nf_state_will_register(ogs_fsm_t *s, scp_event_t *e)
{
    ...
    case OGS_FSM_ENTRY_SIG:
        ...
        ogs_assert(true == scp_nnrf_nfm_send_nf_register(nf_instance));
        break;
